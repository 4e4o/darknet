...
double get_capture_frame_pos_cv(cap_cv *cap);
...
// Draw Detection
int draw_detections_cv_v3(mat_cv* show_img, detection *dets, int num, float thresh, char **names, image **alphabet, int classes, int ext_output);
